...
String htmlData = request.getParameter("petcontent") != null ? request.getParameter("petcontent") : "";
%>
<!DOCTYPE HTML>
...
<script language="javascript">
   ...
   <script>alert('${msg}');
   window.location.href="<%=path %>/commodityList";
...
<div class="content-wrapper">
    ...
    <div class="content-header-left mb-2 clearfix">
      <h3 class="content-header-title mb-0 pull-left">商品修改</h3>
  ...
  <div class="card">
    <div class="card-content">
      <div class="card-body">
        	  <form method="post" action="<%=path %>/commodityedit" name="formcommodity">	
        <div class="form1 form3" >
<ul class="row">
<li class="col-sm-10 col-xs-12"><span>手机编号：</span>
<input type="text" name="commnumber" value="${commodity.commnumber}"  class="form-control">
</li>
<li class="col-sm-10 col-xs-12"><span>手机名称：</span>
 <input type="text" name="commname" value="${commodity.commname}"  class="form-control">
</li>
...
<select class="goods_input" name="cateid"  id="cateid" onchange="categorychang()" style="width:200px;height:35px"  >
	...
	<script language="javascript">document.formcommodity.cateid.value='${cateid}';</script>
		...
		<select class="goods_input" name="sortid" id="sortid" style="width:200px;height:35px"  >
		 <c:forEach  items="${sortList}"  var="v" varStatus="sta">
      		...
      		<script language="javascript">document.formcommodity.sortid.value='${commodity.sortid}';</script>
				 
</li>
<li class="col-sm-10 col-xs-12"><span>颜色：</span>
 <input type="text" name="commobject" value="${commodity.commobject}"  class="form-control">
</li>
<li class="col-sm-10 col-xs-12"><span>尺寸：</span>
...
<table class="pure-table">
 ...
 <tr style="background:#fff;color:#000;border: 1px solid #cbcbcb">
	<td>${model.modname}</td>
<td>${model.modprice}</td>
<td>
<a  onClick="moddelete(${model.modid})"  href="javascript:;">删除</a></td>  
</tr>
...
<li class="col-sm-10 col-xs-12"><span>图片1：</span>
  <input type="text" id="commpicture1"  value="${commodity.commpicture1}" name="commpicture1" style="width:160px;height:30px"  >
                <input type="button" value="上传"  onclick="up1()" style="width:60px" />
</li>
<li class="col-sm-10 col-xs-12"><span>图片2：</span>
  <input type="text" id="commpicture2" value="${commodity.commpicture2}"  name="commpicture2" style="width:160px;height:30px"  >
                <input type="button" value="上传"  onclick="up2()" style="width:60px" />
</li>
<li class="col-sm-10 col-xs-12"><span>图片3：</span>
  <input type="text" id="commpicture3" value="${commodity.commpicture3}"  name="commpicture3" style="width:160px;height:30px"  >
                <input type="button" value="上传"  onclick="up3()" style="width:60px" />
</li>
<li class="col-sm-10 col-xs-12"><span>图片4：</span>
  <input type="text" id="commpicture4" value="${commodity.commpicture4}"  name="commpicture4" style="width:160px;height:30px"  >
...
<li class="col-sm-10 col-xs-12"> <span>详情介绍：</span>
              ...
              <textarea name="commcontent" cols="100" rows="20" style="width:800px;visibility:hidden;">${commodity.commcontent}</textarea>
        </div>
